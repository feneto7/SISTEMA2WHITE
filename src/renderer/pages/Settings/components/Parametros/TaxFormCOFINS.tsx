//--------------------------------------------------------------------
// FORMULÁRIO ESPECÍFICO PARA COFINS
...
// Opções de Situação Tributária para COFINS
const ST_OPTIONS = [
...
export function TaxFormCOFINS({ onSubmit }: TaxFormCOFINSProps): JSX.Element {
